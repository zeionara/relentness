...
struct Relentness: ParsableCommand {
    static var configuration = CommandConfiguration(
        ...
        version: "0.0.7",
        subcommands: [GenerateSample.self, Test.self, TestWithSeeds.self, TestAllFolds.self, HyperSearch.self, ExploreDataset.self, ExportDataset.self, CompareModels.self, EvaluateDataset.self],
