...
public struct OpenKeTester: ModelTester {

    public static let platform = Platform.openke
    ...
    public var initialArgs = ["-m", "relentness", "test"]
    public var initialEnv: [String: String] = [:]

    public var path: URL {
        URL(fileURLWithPath: "/home/\(USER)/relentness")
    }

    public var executable: URL {
        URL(fileURLWithPath: "/home/\(USER)/anaconda3/envs/\(env)/bin/python")
    }
    ...
    public init(
        ...
        logger = Logger(level: logLevel, label: "openke-tester")
